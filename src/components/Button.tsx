...
const variantStyles = {
  primary:
    "active:text-zinc-100/85 bg-congress-800 font-semibold text-congress-100 text-zinc-100 hover:bg-congress-900 hover:bg-zinc-700 active:bg-congress-800 active:bg-zinc-800 dark:bg-congress-600 dark:text-congress-900 dark:hover:bg-congress-500 dark:active:bg-congress-600 dark:active:text-congress-900",
  secondary:
