...
export default function typographyStyles({ theme }: PluginUtils) {
  return {
    ...
    DEFAULT: {
      css: {
        "--tw-article-body": theme("colors.zinc.600"),
        "--tw-article-headings": theme("colors.zinc.900"),
        ...
        "--tw-article-bold": theme("colors.zinc.900"),
        "--tw-article-counters": theme("colors.zinc.900"),
        "--tw-article-bullets": theme("colors.zinc.900"),
        "--tw-article-hr": theme("colors.zinc.100"),
        "--tw-article-quote-borders": theme("colors.zinc.200"),
        "--tw-article-captions": theme("colors.zinc.400"),
        "--tw-article-code": theme("colors.zinc.700"),
        "--tw-article-code-bg": theme("colors.zinc.300 / 0.2"),
        "--tw-article-pre-code": theme("colors.zinc.100"),
        "--tw-article-pre-bg": theme("colors.zinc.900"),
        "--tw-article-pre-border": "transparent",
        "--tw-article-th-borders": theme("colors.zinc.200"),
        "--tw-article-td-borders": theme("colors.zinc.100"),

        "--tw-article-invert-body": theme("colors.zinc.400"),
        "--tw-article-invert-headings": theme("colors.zinc.200"),
        ...
        "--tw-article-invert-bold": theme("colors.zinc.200"),
        "--tw-article-invert-counters": theme("colors.zinc.200"),
        "--tw-article-invert-bullets": theme("colors.zinc.200"),
        "--tw-article-invert-hr": theme("colors.zinc.700 / 0.4"),
        "--tw-article-invert-quote-borders": theme("colors.zinc.500"),
        "--tw-article-invert-captions": theme("colors.zinc.500"),
        "--tw-article-invert-code": theme("colors.zinc.300"),
        "--tw-article-invert-code-bg": theme("colors.zinc.200 / 0.05"),
        "--tw-article-invert-pre-code": theme("colors.zinc.100"),
        "--tw-article-invert-pre-bg": "rgb(0 0 0 / 0.4)",
        "--tw-article-invert-pre-border": theme("colors.zinc.200 / 0.1"),
        "--tw-article-invert-th-borders": theme("colors.zinc.700"),
        "--tw-article-invert-td-borders": theme("colors.zinc.800"),
